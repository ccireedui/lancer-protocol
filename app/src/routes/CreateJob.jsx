...
export default function CreateJob() {
  ...
  const [biddingDeadlineInput, setBiddingDeadlineInput] =
    useState("2022-09-09");
  const [milestoneMaxAmountInput, setMilestoneMaxAmountInput] = useState(2);
  const [milestoneDeadlineInput, setMilestoneDeadlineInput] =
    useState("2022-09-15");
  const [projectDeadlineInput, setProjectDeadlineInput] =
    useState("2022-09-25");

  async function handleJobMint() {
    const { factoryContract, nftContract, signer, userAddress } =
    ...
    try {
      ...
      let tx = await factoryContract
        ...
        .createJob(
          ...
          ethers.utils.parseEther(paymentAmountInput.toString()),
          ethers.utils.parseEther(minBidAmountInput.toString()),
          biddingDeadline,
        ...
        <Container maxWidth="lg" sx={{ marginTop: "2em" }}>
          ...
          <div className="flex mt-10 flex-col gap-5">
            ...
            <TextField
              ...
              onChange={(e) => {
                setFreelancerMaxAmountInput(e.target.value);
              }}
              label="Freelancer Max Amount"
              variant="outlined"
            />
            ...
            <TextField
              ...
              type="number"
              onChange={(e) => {
                setMinBidAmountInput(e.target.value);
              }}
              value={minBidAmountInput}
              label="Min Bidder Amount (ETH)"
              variant="outlined"
            />
            ...
            <TextField
              ...
              onChange={(e) => {
                setBiddingDeadlineInput(e.target.value);
              }}
            ...
            <TextField
              ...
              type="number"
              onChange={(e) => {
                setMilestoneMaxAmountInput(e.target.value);
              }}
              value={milestoneMaxAmountInput}
              label="Milestone Max Amount"
              variant="outlined"
            />
            ...
            <TextField
              ...
              onChange={(e) => {
                setMilestoneDeadlineInput(e.target.value);
              }}
            ...
            <TextField
              ...
              onChange={(e) => {
                setProjectDeadlineInput(e.target.value);
              }}
